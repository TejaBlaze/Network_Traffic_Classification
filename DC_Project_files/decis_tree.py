from sklearn.model_selection import cross_val_score                           #Library for evaluation of cross validation and scores
from sklearn.tree import DecisionTreeClassifier                               #Library for Decision trees
...
#Fit the data
clf = DecisionTreeClassifier(random_state=0)                                  #Declare classifier for Decision tree with random state set to np.random instance
clf.fit(tr_data, tr_target)                                                   #Fit the corresponding inputs and outputs and assign this object to the classifier
