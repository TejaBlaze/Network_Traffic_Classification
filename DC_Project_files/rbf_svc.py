...
#Fit the data
clf = svm.SVC(kernel='rbf')                                                   #Classifier object for the SVC model
ba_data, ba_target = random_batch(tr_data, tr_target, 10000)                   #Create a random batch of dataset of size 10000
